...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Prathamesh Dabre/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Prathamesh Dabre' => 'pdabre@e-emphasys.com' }
  s.source           = { :git => 'https://github.com/Prathamesh Dabre/BlinkingLabel.git', :tag => s.version.to_s }
